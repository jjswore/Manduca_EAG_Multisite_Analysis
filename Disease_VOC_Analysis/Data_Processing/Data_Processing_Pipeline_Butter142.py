...
def run():
   ...
   #     DirList=['/Users/joshswore/Manduca/MultiChannel/WildType/Covid/Raw_Data']
    ...
    s = '/Users/joshswore/Manduca/MultiChannel/WildType/Covid/Processed_Data/Official/ButterLC1_HC4.1_O2/'

    process_data(DirList, savedir=f'{s}/Raw/Both_Channels/',
                 SUB=False, SUM=False, Norm=False, Smoothen=False, LOG=False, Butter=[1, 4.1, 2], RETURN='SAVE')
    process_data(DirList, savedir=f'{s}/YY_Normalized/Both_Channels/',
                 SUB=False, SUM=False, Norm='YY', Smoothen=False, LOG=False, Butter=[1, 4.1, 2], RETURN='SAVE')
    process_data(DirList, savedir=f'{s}/Smoothened/Both_Channels/',
                 SUB=False, SUM=False, Norm=False, Smoothen=True, LOG=False, Butter=[1, 4.1, 2], RETURN='SAVE')
    process_data(DirList, savedir=f'{s}/YY_Normalized_Smoothened/Both_Channels/',
                 SUB=False, SUM=False, Norm='YY', Smoothen=True, LOG=False, Butter=[1, 4.1, 2], RETURN='SAVE')
