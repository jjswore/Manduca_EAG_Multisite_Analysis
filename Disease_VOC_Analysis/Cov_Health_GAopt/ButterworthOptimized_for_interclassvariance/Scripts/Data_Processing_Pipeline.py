...
def run():
   ...
   #     DirList=['/Users/joshswore/Manduca/MultiChannel/WildType/Covid/Raw_Data']
    ...
    s = '/Users/joshswore/Manduca/MultiChannel/WildType/Covid/Processed_Data/Official/NoFilter/'

    process_data(DirList, savedir=f'{s}/Smoothened/Both_Channels/',
                 SUB=False, SUM=False, Norm=False, Smoothen=True, LOG=False, Butter=[1, 5, 2], B_filt=False, RETURN='SAVE')
    process_data(DirList, savedir=f'{s}/YY_Normalized_Smoothened/Both_Channels/',
                 SUB=False, SUM=False, Norm='YY', Smoothen=True, LOG=False, Butter=[1, 5, 2], B_filt=False, RETURN='SAVE')
    ...
    for D in Dlist:
        ...
        #thresholds to use for quality control
        ThreshList=[1000]
        all_dfs = []
