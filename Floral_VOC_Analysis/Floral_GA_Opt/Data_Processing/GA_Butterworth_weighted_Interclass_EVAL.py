...
from Manduca_Multisite_EAG_Analysis.Floral_VOC_Analysis.Floral_GA_Opt.Data_Processing.EAG_DataProcessing_Library import butter_bandpass_filter
import random
...
params, statistics=main(data=df, POPULATION_SIZE=300, TOURNAMENT_SIZE=3, CROSS_PROB=.5, MUT_PROB=.3, G=150)
